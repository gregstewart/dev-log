<cfcomponent name="LoginManagerTest" extends="org.cfcunit.framework.TestCase">
	
	<cfproperty name="variables.LoginManager" type="WEB-INF.cftags.component" hint=""/>
    ...
    <cffunction name="testAttemptLogin" returntype="void" access="public" output="false">
	    <cfset assertTrue(false, "Stub test method - put your own test here") />
	</cffunction>
