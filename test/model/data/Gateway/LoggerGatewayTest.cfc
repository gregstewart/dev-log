<cfcomponent name="LoggerGatewayTest" extends="org.cfcunit.framework.TestCase">
	
	<cfproperty name="variables.LoggerGateway" type="WEB-INF.cftags.component" hint=""/>
    ...
    <cffunction name="testGetSummaryByDate" returntype="void" access="public" output="false">
	    <cfset assertTrue(false, "Stub test method - put your own test here") />
	</cffunction>
                	        
            
                
    <cffunction name="testGetCalendarData" returntype="void" access="public" output="false">
	    <cfset assertTrue(false, "Stub test method - put your own test here") />
	</cffunction>
