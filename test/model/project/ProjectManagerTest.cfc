<cfcomponent name="ProjectManagerTest" extends="org.cfcunit.framework.TestCase">
	
	<cfproperty name="variables.ProjectManager" type="WEB-INF.cftags.component" hint=""/>
    ...
    <cffunction name="testGetProjects" returntype="void" access="public" output="false">
    ...
    <cffunction name="testSet" returntype="void" access="public" output="false">
	    <cfset assertTrue(false, "Stub test method - put your own test here") />
	</cffunction>
